...
/**
 * The equirect-imagery variant (the 2026-07-04 pipeline, supersampled
 * 2026-07-05): identical nodes and edges, `imagery: "equirect"` with the
 * [512, 4096, 8192] LOD ladder (8192 = the on-zoom tier). The e2e suite runs
