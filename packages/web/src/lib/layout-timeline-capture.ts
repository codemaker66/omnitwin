...
export type TimelineCaptureFurnitureSource = "nearest-keyframe" | "saved-layout" | "unavailable";
...
export function captureFurnitureVisibilityForTimeline({
  ...
  return {
    source: captureNearestKeyframe
      ? "nearest-keyframe"
      : timelinePreviewActive ? "unavailable" : "saved-layout",
    savedLayoutVisible: !timelinePreviewActive,
    interpolatedPreviewVisible: false,
    nearestKeyframeVisible: captureNearestKeyframe,
    diagramLabelsVisible: !timelinePreviewActive,
  };
}
