...
export function createDanceFloorPanelProxy(
  ...
  root.userData.evidenceImage = null;
  root.userData.provenance = "generated";
  root.userData.authority = "presentation-only";
  root.userData.measuredGeometry = false;
  root.userData.sourceKind = "procedural-code-no-retained-source";
  root.userData.generator = "Venviewer procedural TypeScript factory";
