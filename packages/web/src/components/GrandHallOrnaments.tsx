...
export const GRAND_HALL_ORNAMENT_SCENE_AUTHORITY = Object.freeze({
...
const DISABLED_ORNAMENT_RAYCAST = (): void => undefined;
...
export function GrandHallOrnaments({
  ...
  const ornamentGroupRef = useRef<Group | null>(null);
  ...
  useLayoutEffect(() => {
    ornamentGroupRef.current?.traverse((object) => {
      Object.assign(object.userData, GRAND_HALL_ORNAMENT_SCENE_AUTHORITY);
      object.raycast = DISABLED_ORNAMENT_RAYCAST;
    });
  }, [ceilingOrnamentsVisible, hangingLightsVisible, wallOrnamentsVisible]);

  return (
    <group
      ref={ornamentGroupRef}
      name="grand-hall-ornaments"
      userData={GRAND_HALL_ORNAMENT_SCENE_AUTHORITY}
    >
