...
const ladder: RoomSplatLadder = {
  environment: [{ url: "sky", file: "sky", tree: false }],
  coarse: [{ url: "coarse", file: "coarse", tree: false }],
...
describe("useSplatDelivery", () => {
  ...
  it("resets on a room change and ignores callbacks from the disposed room", () => {
    const second: RoomSplatLadder = { environment: [], coarse: [{ url: "second", file: "second", tree: false }], sharp: [{ url: "second-fine", file: "second-fine", tree: false }] };
