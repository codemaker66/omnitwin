...
// ---------------------------------------------------------------------------
// 4. Robert Adam Room — 9.7m × 5.6m main + connected area
// Roughly rectangular with ornate ceiling medallion (visible in photo)
// For V1: simple rectangle matching known dimensions
// ---------------------------------------------------------------------------
