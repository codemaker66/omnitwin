...
export const CRAFT_QUESTIONS = [
  ...
  },
  {
    ...
    scene:
      "You find out the way everyone finds out: someone tells you over work, plainly, as though it were weather. The mill leat runs through the low cottages, and every third year it floods them, and the town has known for sixty years how to move it and has not, because moving it takes the water off the mill. Everything here is built on that. Your bench included.",
    options: [
      {
        lead: "Move the water.",
