# Planner venue crests

`trades-hall-glasgow-crest.png` is the unmodified transparent PNG supplied by
Blake on 7 September 2026 for the selected Trades Hall planner identity.
It is used only for the venue with slug `trades-hall-glasgow`.

Source attachment: `codex-clipboard-48b2ede5-e73c-473d-8b69-ab7b185e5cf4.png`.
