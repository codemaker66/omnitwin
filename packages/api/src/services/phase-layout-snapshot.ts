...
function verifyProof(
  ...
  if (!parsed.success) throw new PhaseLayoutSnapshotConflictError("CONFIGURATION_PROOF_INVALID");
  ...
  if (
    ...
    throw new PhaseLayoutSnapshotConflictError("CONFIGURATION_PROOF_INVALID");
  }
