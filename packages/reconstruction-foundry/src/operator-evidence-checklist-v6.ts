...
export const FOUNDRY_OPERATOR_EVIDENCE_CHECKLIST_V6 =
  "omnitwin.foundry.operator-evidence-checklist.v6";
export const FOUNDRY_OPERATOR_EVIDENCE_CHECKLIST_V6_DIGEST_DOMAIN =
  "VENVIEWER_FOUNDRY_OPERATOR_EVIDENCE_CHECKLIST_V6";
...
function gaussianPlyRequestDefinition(
  ...
  if (unknown === undefined) {
    throw new FoundryIntegrityError(
      ...
      `Source Facts V6 does not export the frozen unknown definition ${code}.`,
    );
  }
...
type PointPlyEvidenceCode = Extract<EvidenceCode, `POINT_PLY_${string}`>;

function pointPlyRequestDefinition(
  code: PointPlyEvidenceCode,
  category: FoundryOperatorEvidenceCategory,
): RequestDefinition {
  const unknown = FOUNDRY_POINT_PLY_UNKNOWNS.find(
    (candidate) => candidate.code === code,
  );
  if (unknown === undefined) {
    throw new FoundryIntegrityError(
      "OPERATOR_EVIDENCE_POINT_PLY_DEFINITION_MISSING",
      `Source Facts V6 does not export the frozen point PLY unknown definition ${code}.`,
    );
  }
  return requestDefinition(
    "unknown",
...
function mediaRequestDefinition(
  ...
  if (unknown === undefined) {
    throw new FoundryIntegrityError(
      ...
      `Source Facts V6 does not export the frozen media unknown definition ${code}.`,
    );
  }
  return requestDefinition(
    "unknown",
...
type RegistrationDocumentEvidenceCode = Extract<
  EvidenceCode,
  `CALIBRATION_${string}` | `TRAJECTORY_${string}`
>;

function registrationDocumentRequestDefinition(
  code: RegistrationDocumentEvidenceCode,
  category: FoundryOperatorEvidenceCategory,
): RequestDefinition {
  const unknown = [
    ...FOUNDRY_CALIBRATION_DOCUMENT_UNKNOWNS,
  ...
  if (unknown === undefined) {
    throw new FoundryIntegrityError(
      "OPERATOR_EVIDENCE_REGISTRATION_DOCUMENT_DEFINITION_MISSING",
      `Source Facts V6 does not export the frozen registration-document unknown definition ${code}.`,
    );
  }
  return requestDefinition(
    "unknown",
...
const REQUEST_DEFINITIONS = {
  ...
  OUTSIDE_SOURCE_FACTS_V6: requestDefinition(
    "gap",
    "bounded_inspection",
    "high",
    "Outside Source Facts V6",
    "The receipt has candidate source families, but Source Facts V6 does not inspect this file format.",
  ...
  SOURCE_FACTS_NOT_ESTABLISHED: requestDefinition(
    ...
    "Source Facts V6 targeted the file but did not establish its bounded format facts.",
  ...
  CALIBRATION_EXTRINSIC_CONVENTION_UNKNOWN: registrationDocumentRequestDefinition(
    "CALIBRATION_EXTRINSIC_CONVENTION_UNKNOWN",
    "registration_input",
  ),
  CALIBRATION_FIELD_SEMANTICS_UNKNOWN: registrationDocumentRequestDefinition(
    "CALIBRATION_FIELD_SEMANTICS_UNKNOWN",
    "bounded_inspection",
  ),
  CALIBRATION_INTRINSICS_AND_DISTORTION_UNKNOWN: registrationDocumentRequestDefinition(
    "CALIBRATION_INTRINSICS_AND_DISTORTION_UNKNOWN",
    "registration_input",
  ),
  CALIBRATION_PROVENANCE_UNKNOWN: registrationDocumentRequestDefinition(
    "CALIBRATION_PROVENANCE_UNKNOWN",
    "source_provenance",
  ),
  CALIBRATION_RIGHTS_UNKNOWN: registrationDocumentRequestDefinition(
    "CALIBRATION_RIGHTS_UNKNOWN",
    "rights_decision",
  ),
  CALIBRATION_SENSOR_APPLICABILITY_UNKNOWN: registrationDocumentRequestDefinition(
    "CALIBRATION_SENSOR_APPLICABILITY_UNKNOWN",
    "source_provenance",
  ),
  CALIBRATION_TIMING_AND_READOUT_UNKNOWN: registrationDocumentRequestDefinition(
    "CALIBRATION_TIMING_AND_READOUT_UNKNOWN",
    "registration_input",
  ),
  CALIBRATION_UNCERTAINTY_AND_VALIDATION_UNKNOWN: registrationDocumentRequestDefinition(
    "CALIBRATION_UNCERTAINTY_AND_VALIDATION_UNKNOWN",
    "independent_control",
  ),
  ...
  POINT_PLY_ACCURACY_AND_UNCERTAINTY_UNKNOWN: pointPlyRequestDefinition(
    "POINT_PLY_ACCURACY_AND_UNCERTAINTY_UNKNOWN",
    "independent_control",
  ),
  POINT_PLY_ATTRIBUTE_VALUES_UNKNOWN: pointPlyRequestDefinition(
    "POINT_PLY_ATTRIBUTE_VALUES_UNKNOWN",
    "bounded_inspection",
  ),
  POINT_PLY_FRAME_CRS_AND_AXIS_UNKNOWN: pointPlyRequestDefinition(
    "POINT_PLY_FRAME_CRS_AND_AXIS_UNKNOWN",
    "registration_input",
  ),
  POINT_PLY_GEOMETRY_ROLE_UNKNOWN: pointPlyRequestDefinition(
    "POINT_PLY_GEOMETRY_ROLE_UNKNOWN",
    "source_provenance",
  ),
  POINT_PLY_PHYSICAL_BOUNDS_AND_COMPLETENESS_UNKNOWN: pointPlyRequestDefinition(
    "POINT_PLY_PHYSICAL_BOUNDS_AND_COMPLETENESS_UNKNOWN",
    "bounded_inspection",
  ),
  POINT_PLY_PROPERTY_SEMANTICS_UNKNOWN: pointPlyRequestDefinition(
    "POINT_PLY_PROPERTY_SEMANTICS_UNKNOWN",
    "bounded_inspection",
  ),
  POINT_PLY_PROVENANCE_AND_CAPTURE_CLASS_UNKNOWN: pointPlyRequestDefinition(
    "POINT_PLY_PROVENANCE_AND_CAPTURE_CLASS_UNKNOWN",
    "source_provenance",
  ),
  POINT_PLY_REGISTRATION_UNKNOWN: pointPlyRequestDefinition(
    "POINT_PLY_REGISTRATION_UNKNOWN",
    "independent_control",
  ),
  POINT_PLY_RIGHTS_UNKNOWN: pointPlyRequestDefinition(
    "POINT_PLY_RIGHTS_UNKNOWN",
    "rights_decision",
  ),
  POINT_PLY_UNITS_AND_SCALE_UNKNOWN: pointPlyRequestDefinition(
    "POINT_PLY_UNITS_AND_SCALE_UNKNOWN",
    "source_provenance",
  ),
  ...
  TRAJECTORY_ACCURACY_AND_DRIFT_UNKNOWN: registrationDocumentRequestDefinition(
    "TRAJECTORY_ACCURACY_AND_DRIFT_UNKNOWN",
    "independent_control",
  ),
  TRAJECTORY_CLOCK_DOMAIN_AND_TIME_UNITS_UNKNOWN: registrationDocumentRequestDefinition(
    "TRAJECTORY_CLOCK_DOMAIN_AND_TIME_UNITS_UNKNOWN",
    "registration_input",
  ),
  TRAJECTORY_COMPLETENESS_AND_SYNCHRONIZATION_UNKNOWN: registrationDocumentRequestDefinition(
    "TRAJECTORY_COMPLETENESS_AND_SYNCHRONIZATION_UNKNOWN",
    "registration_input",
  ),
  TRAJECTORY_COORDINATE_FRAME_AND_UNITS_UNKNOWN: registrationDocumentRequestDefinition(
    "TRAJECTORY_COORDINATE_FRAME_AND_UNITS_UNKNOWN",
    "registration_input",
  ),
  TRAJECTORY_FIELD_SEMANTICS_UNKNOWN: registrationDocumentRequestDefinition(
    "TRAJECTORY_FIELD_SEMANTICS_UNKNOWN",
    "bounded_inspection",
  ),
  TRAJECTORY_PROVENANCE_UNKNOWN: registrationDocumentRequestDefinition(
    "TRAJECTORY_PROVENANCE_UNKNOWN",
    "source_provenance",
  ),
  TRAJECTORY_RIGHTS_UNKNOWN: registrationDocumentRequestDefinition(
    "TRAJECTORY_RIGHTS_UNKNOWN",
    "rights_decision",
  ),
  TRAJECTORY_TRANSFORM_CONVENTION_UNKNOWN: registrationDocumentRequestDefinition(
    "TRAJECTORY_TRANSFORM_CONVENTION_UNKNOWN",
    "registration_input",
  ),
...
const GROUP_DESCRIPTORS = [
  {
    ...
    meaning:
      "Resolve format ambiguity, missing format identification, unsupported V6 coverage, or a bounded inspection failure before relying on deeper source facts.",
  },
  {
...
const ArtifactBaseSchema = z
  .object({
    schemaVersion: z.literal(FOUNDRY_OPERATOR_EVIDENCE_CHECKLIST_V6),
...
export const FoundryOperatorEvidenceChecklistV6Schema = z
  .discriminatedUnion("state", [AvailableArtifactSchema, BlockedArtifactSchema])
  .superRefine(validateArtifact);
export type FoundryOperatorEvidenceChecklistV6 = z.infer<
  typeof FoundryOperatorEvidenceChecklistV6Schema
>;
...
function issueArtifact(
  ...
  return FoundryOperatorEvidenceChecklistV6Schema.parse({
    ...payload,
...
export interface CompileFoundryOperatorEvidenceChecklistV6Input {
  readonly readiness: unknown;
}

/**
 * Builds a deterministic, unperformed evidence-request checklist from only an
 * exact Source Readiness Map V6. It performs no evidence acquisition or work.
 */
export function compileFoundryOperatorEvidenceChecklistV6(
  input: CompileFoundryOperatorEvidenceChecklistV6Input,
): FoundryOperatorEvidenceChecklistV6 {
  const readiness = FoundrySourceReadinessMapV6Schema.parse(input.readiness);
  if (readiness.state === "blocked") {
    ...
    return issueArtifact({
      schemaVersion: FOUNDRY_OPERATOR_EVIDENCE_CHECKLIST_V6,
...
export interface VerifyFoundryOperatorEvidenceChecklistV6Input {
  readonly readiness: unknown;
  readonly checklist: unknown;
}

export function verifyFoundryOperatorEvidenceChecklistV6(
  input: VerifyFoundryOperatorEvidenceChecklistV6Input,
): FoundryOperatorEvidenceChecklistV6 {
  const actual = FoundryOperatorEvidenceChecklistV6Schema.parse(
    input.checklist,
  );
  const expected = compileFoundryOperatorEvidenceChecklistV6({
    readiness: input.readiness,
  });
  if (
    serializeFoundryOperatorEvidenceChecklistV6(actual) !==
    serializeFoundryOperatorEvidenceChecklistV6(expected)
  ) {
    throw new FoundryIntegrityError(
...
export function serializeFoundryOperatorEvidenceChecklistV6(
  value: FoundryOperatorEvidenceChecklistV6,
): string {
  return stableCanonicalJson(
    toCanonicalJson(FoundryOperatorEvidenceChecklistV6Schema.parse(value)),
  );
}
