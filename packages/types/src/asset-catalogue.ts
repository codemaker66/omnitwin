...
export const CANONICAL_ASSETS: readonly CanonicalAsset[] = [
  ...
  // Supplied source geometry/materials and calibration are recorded beside each GLB.
  {
    ...
    seatCount: null, collisionType: "box", tableShape: "rectangular",
    maxCount: null, subtitle: "Black cloth included", color: "#242424",
  ...
  },
  {
    ...
    dimensionStatus: "approximate",
    seatCount: null, collisionType: "box", tableShape: "rectangular",
    maxCount: null, subtitle: "White cloth included", color: "#eeeae3",
  ...
  },
  {
    ...
    dimensionStatus: "approximate",
    seatCount: null, collisionType: "box", tableShape: "rectangular",
    maxCount: null, subtitle: "Wooden top · no cloth", color: "#8b6140",
  ...
  },
  {
    ...
    dimensionStatus: "approximate",
    seatCount: null, collisionType: "box", tableShape: "rectangular",
    maxCount: null, subtitle: "Signing table for the ceremony", color: "#eeeae3",
  ...
  },
  {
    ...
    dimensionStatus: "approximate",
    seatCount: 1, collisionType: "box", tableShape: null,
    maxCount: null, subtitle: "Padded · stackable", color: "#a28a65",
  ...
  },
  {
    ...
    dimensionStatus: "approximate",
    seatCount: null, collisionType: "box", tableShape: null,
    maxCount: null, subtitle: "Folding screen", color: "#764735",
  ...
  },
  {
    ...
    dimensionStatus: "approximate",
    seatCount: null, collisionType: "box", tableShape: null,
    maxCount: null, subtitle: "Service counter for catering", color: "#805d45",
    meshUrl: "/models/furniture/servery-unit/v1/model.glb",
    thumbnailUrl: "/models/furniture/servery-unit/v1/preview.webp",
    equipmentTags: [],
  },

  // --- Trades Hall equipment intake (source document dated 2026-09-05) -------
  // Identities for equipment the venue reports owning but which had no
  // catalogue entry, so stock can be recorded against a real item instead of
  // being absent. Reported physical quantities live in the venue inventory,
  // never here: this list is identity, geometry and presentation only.
  //
  // Dimensions: the source document states no chair, screen or microphone
  // measurements, so every envelope below is a provisional planning size
  // (`dimensionStatus: "approximate"`) and none of them is a measured venue
  // fact. The staging decks are the exception in plan — 6 × 4 ft and 6 × 3 ft
  // are stated — but their deck height is not, so they stay approximate too.
  {
    id: "ea8b110e-b4a6-5185-8ee3-932d77508721",
    slug: "chiavari-chair",
    name: "Chiavari Wedding Chair",
    category: "chair",
    // Manufacturer-standard Chiavari envelope; the venue's own units are unmeasured.
    widthM: 0.41, depthM: 0.41, heightM: 0.92,
    dimensionStatus: "approximate",
    seatCount: 1, collisionType: "box", tableShape: null,
    maxCount: null, subtitle: "Ballroom chair · stackable", color: "#c9a227",
    equipmentTags: [],
  },
  {
    id: "45bd06d4-44b4-5e8e-8df7-5ddd513feb9e",
    slug: "gallery-chair-red-gold",
    name: "Red and Gold Gallery Chair",
    category: "chair",
    widthM: 0.45, depthM: 0.45, heightM: 0.90,
    dimensionStatus: "approximate",
    seatCount: 1, collisionType: "box", tableShape: null,
    maxCount: null, subtitle: "Gallery seating · red and gold", color: "#8c2f2f",
    equipmentTags: [],
  },
  {
    id: "34780845-a465-5abb-ab8f-953ff90bc9c1",
    slug: "pink-chair",
    name: "Pink Chair",
    category: "chair",
    widthM: 0.45, depthM: 0.45, heightM: 0.90,
    dimensionStatus: "approximate",
    seatCount: 1, collisionType: "box", tableShape: null,
    maxCount: null, subtitle: "Padded · stackable", color: "#c98a9b",
    equipmentTags: [],
  },
  // Four highchairs, kept as separate identities because the venue counts them
  // separately. Merging them into one row would invent a pooled count.
  {
    id: "67974103-36a8-59df-8102-13fdee55d97e",
    slug: "highchair-white",
    name: "White Highchair",
    category: "chair",
    widthM: 0.50, depthM: 0.55, heightM: 0.95,
    dimensionStatus: "approximate",
    seatCount: 1, collisionType: "box", tableShape: null,
    maxCount: null, subtitle: "Child seat", color: "#f0ede8",
    equipmentTags: [],
  },
  {
    id: "f642b94e-8f3a-5fbd-bb15-8e071113f5de",
    slug: "highchair-green",
    name: "Green Highchair",
    category: "chair",
    widthM: 0.50, depthM: 0.55, heightM: 0.95,
    dimensionStatus: "approximate",
    seatCount: 1, collisionType: "box", tableShape: null,
    maxCount: null, subtitle: "Child seat", color: "#4c6b4a",
    equipmentTags: [],
  },
  {
    id: "f4bf707a-c565-5f52-9afb-2340b1ffbaa9",
    slug: "highchair-blue",
    name: "Blue Highchair",
    category: "chair",
    widthM: 0.50, depthM: 0.55, heightM: 0.95,
    dimensionStatus: "approximate",
    seatCount: 1, collisionType: "box", tableShape: null,
    maxCount: null, subtitle: "Child seat", color: "#3f5d7d",
    equipmentTags: [],
  },
  {
    id: "1ca08680-3741-5119-9db9-b7aa1c554e2e",
    slug: "highchair-wooden",
    name: "Wooden Highchair",
    category: "chair",
    widthM: 0.50, depthM: 0.55, heightM: 0.95,
    dimensionStatus: "approximate",
    seatCount: 1, collisionType: "box", tableShape: null,
    maxCount: null, subtitle: "Child seat", color: "#8b6140",
    equipmentTags: [],
  },
  // Staging decks tile into a stage; like the existing platforms they imply
  // dimmable lighting so a speaker can be lit without flooding the room.
  {
    id: "11d806d6-ac85-5519-b25f-78e86b9141ce",
    slug: "staging-deck-6x4",
    name: "6ft × 4ft Staging Deck",
    category: "stage",
    widthM: 1.83, depthM: 1.22, heightM: 0.40,
    dimensionStatus: "approximate",
    seatCount: null, collisionType: "box", tableShape: null,
    maxCount: null, subtitle: "Tiles into a stage", color: "#4a4a4a",
    equipmentTags: ["dimmable-lighting"],
  },
  {
    id: "5276f0e8-533c-5aa3-acf2-a9631d3d8cef",
    slug: "staging-deck-6x3",
    name: "6ft × 3ft Staging Deck",
    category: "stage",
    widthM: 1.83, depthM: 0.91, heightM: 0.40,
    dimensionStatus: "approximate",
    seatCount: null, collisionType: "box", tableShape: null,
    maxCount: null, subtitle: "Tiles into a stage", color: "#4a4a4a",
    equipmentTags: ["dimmable-lighting"],
  },
  // The source writes the screen size as `65’`, so the unit is unconfirmed; the
  // envelope below is a generic mobile-screen size, not a stated diagonal.
  {
    id: "83681742-320e-5429-af35-e11fb190f9a1",
    slug: "hisense-television",
    name: "Hisense Television",
    category: "av",
    widthM: 1.50, depthM: 0.55, heightM: 1.80,
    dimensionStatus: "approximate",
    seatCount: null, collisionType: "box", tableShape: null,
    maxCount: null, subtitle: "Screen on a mobile stand", color: "#1f1f24",
    equipmentTags: ["power-outlet", "av-cable-path"],
  },
  {
    id: "c37b53d1-ab5c-5ae4-8ed5-50c069ef593f",
    slug: "handheld-microphone",
    name: "Handheld Microphone",
    category: "av",
    widthM: 0.05, depthM: 0.05, heightM: 0.23,
    dimensionStatus: "approximate",
    seatCount: null, collisionType: "box", tableShape: null,
    maxCount: null, subtitle: "Handheld · for a speaker or host", color: "#2a2a2a",
    equipmentTags: ["power-outlet", "av-cable-path"],
  },
  {
    id: "48850450-aec6-5c31-b9fd-68414bc726e8",
    slug: "lapel-microphone",
    name: "Lapel Microphone",
    category: "av",
    widthM: 0.05, depthM: 0.05, heightM: 0.10,
    dimensionStatus: "approximate",
    seatCount: null, collisionType: "box", tableShape: null,
    maxCount: null, subtitle: "Clip-on · worn by the speaker", color: "#2a2a2a",
    equipmentTags: ["power-outlet", "av-cable-path"],
  },
];
