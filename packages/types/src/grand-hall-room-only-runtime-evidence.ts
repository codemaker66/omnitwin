...
const AcceptedMembershipArtifactSchema = z
  .object({
    schemaVersion: z.literal("omnitwin.foundry.grand-hall-room-membership.v2"),
...
const AcceptedClosedBoundaryArtifactSchema = z
  .object({
    schemaVersion: z.literal("venviewer.grand-hall-closed-room-boundary.v1"),
    sha256: RuntimeSha256Schema,
    byteLength: EvidenceByteLengthSchema,
...
const AcceptedPortalDecisionArtifactSchema = z
  .object({
    schemaVersion: z.literal("venviewer.grand-hall-portal-decision.v1"),
    sha256: RuntimeSha256Schema,
    byteLength: EvidenceByteLengthSchema,
...
const AcceptedPanoramaMaskSetArtifactSchema = z
  .object({
    schemaVersion: z.literal("venviewer.grand-hall-panorama-mask-set.v1"),
    sha256: RuntimeSha256Schema,
    byteLength: EvidenceByteLengthSchema,
...
const AcceptedPointMaskArtifactSchema = z
  .object({
    schemaVersion: z.literal("venviewer.grand-hall-point-mask.v1"),
    sha256: RuntimeSha256Schema,
    byteLength: EvidenceByteLengthSchema,
    state: z.literal("human_accepted_complete"),
    encoding: z.literal("source_point_membership_bitset_v1"),
  })
  .strict();
  ...
  .object({
    ...
    acceptedScope: z
      .object({
        ...
        pointMaskArtifact: AcceptedPointMaskArtifactSchema,
      })
      .strict(),
    humanReview: z
      .object({
    ...
    croppedVisual: z
      .object({
        derivation: z.literal(
          "accepted_closed_boundary_and_point_mask_applied_to_source_capture_v1",
        ),
