...
2. **Whether the live tileset's data attribution is actually non-empty is still unverified** — unchanged by this update, still blocked on `VITE_GOOGLE_MAPS_TILES_KEY` landing (Tasks 6/8/11).
