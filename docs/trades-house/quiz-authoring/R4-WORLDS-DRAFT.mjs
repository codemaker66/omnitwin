...
export const SCENES = [
  // ===== ACT I — THE PERSONA: what you show ================================
  {
    ...
    options: [
      { lead: "The iron.", ledger: "Came in with iron.", world: "hammermen",
      ...
      { lead: "The cuttings.", ledger: "Came in with cuttings, most of them alive.", world: "gardeners",
      ...
      { lead: "The pattern-book.", ledger: "Came in with a book of measures.", world: "tailors",
        ...
        axes: { a2: 3, a4: 1 } },
      { lead: "The boots.", ledger: "Came in on my feet.", world: "cordiners",
  ...
  },
  {
    ...
    options: [
      { lead: "Straight in.", ledger: "Went into the river.", world: "fleshers",
        ...
        axes: { a1: -1, a2: -3, a4: 3 } },
      { lead: "The boat pole.", ledger: "Reached her with the ash pole.", world: "wrights",
      ...
      { lead: "Wake the whole bank.", ledger: "Woke the whole bank.", world: "barbers",
        ...
        axes: { a1: -1, a3: -3, a5: -1 } },
      { lead: "The line you can see.", ledger: "Walked the gravel seam.", world: "weavers",
  ...
  },
  {
    ...
    options: [
      { lead: "Mend it exactly.", ledger: "Mended the fence as it was.", world: "coopers",
      ...
      { lead: "Find out first.", ledger: "Asked what the fence was for.", world: "weavers",
      ...
      { lead: "Mend it better.", ledger: "Mended the fence better than they asked.", world: "wrights",
      ...
      { lead: "Make it useful.", ledger: "Rehung the fence as a gate.", world: "gardeners",
  ...
  },
  {
    ...
    options: [
      { lead: "Your own name.", ledger: "Kept my own name.", world: "coopers",
      ...
      { lead: "The trade.", ledger: "Took the name of the work.", world: "bakers",
        ...
        axes: { a2: -2, a3: -1, a5: 1 } },
      { lead: "Whatever they land on.", ledger: "Let the town name me.", world: "maltmen",
      ...
      { lead: "Something you are not yet.", ledger: "Took a name I had not earned.", world: "dyers",
  ...
  // ===== ACT II — THE SHADOW: what you deny, and what tempts ===============
  {
    ...
    options: [
      { lead: "Let the work speak.", ledger: "Let the work speak.", world: "masons",
      ...
      { lead: "Say it out loud.", ledger: "Said it out loud.", world: "hammermen",
        ...
        axes: { a1: 2, a2: 2, a4: 3 } },
      { lead: "Learn the warmth.", ledger: "Learned the warmth.", world: "maltmen",
        ...
        axes: { a1: -2, a2: -1, a3: -3 } },
      { lead: "Mend what comes back.", ledger: "Mended what came back.", world: "skinners",
  ...
  },
  {
    ...
    options: [
      { lead: "Count it true.", ledger: "Counted it true.", world: "coopers",
      ...
      { lead: "Take the difference.", ledger: "Took the difference.", world: "fleshers",
      ...
      { lead: "Tell him.", ledger: "Told him.", world: "barbers",
        ...
        axes: { a1: -1, a3: -2, a5: -1 } },
      { lead: "Put it to use.", ledger: "Put it to use.", world: "dyers",
  ...
  },
  {
    ...
    options: [
      { lead: "Put yours in first.", ledger: "Put mine in first.", world: "bakers",
      ...
      { lead: "Make the list.", ledger: "Made the list.", world: "weavers",
        ...
        axes: { a1: 1, a2: 2, a4: -2 } },
      { lead: "Keep the seed.", ledger: "Kept the seed.", world: "gardeners",
      ...
      { lead: "Stretch what there is.", ledger: "Stretched what there was.", world: "maltmen",
  ...
  },
  {
    ...
    options: [
      { lead: "Open it.", ledger: "Opened the door.", world: "hammermen",
      ...
      { lead: "Keep it shut.", ledger: "Kept it shut.", world: "skinners",
        ...
        axes: { a1: 2, a4: -2, a5: -3 } },
      { lead: "Send for her.", ledger: "Sent for her.", world: "barbers",
      ...
      { lead: "Work on the wall.", ledger: "Worked on the wall.", world: "masons",
  ...
  // ===== ACT III — THE SELF: what you are when it costs ====================
  {
    ...
    options: [
      { lead: "Move the water.", ledger: "Moved the water.", world: "wrights",
      ...
      { lead: "Raise the houses.", ledger: "Raised the houses.", world: "masons",
      ...
      { lead: "Say it at the meeting.", ledger: "Said it at the meeting.", world: "tailors",
        ...
        axes: { a2: 3, a3: -1, a4: 2 } },
      { lead: "Leave.", ledger: "Would have walked out.", world: "cordiners",
  ...
  },
  {
    ...
    options: [
      { lead: "Everything, in order.", ledger: "Taught everything, in order.", world: "weavers",
      ...
      { lead: "The last thing last.", ledger: "Kept the last thing back.", world: "tailors",
        ...
        axes: { a2: 3, a4: 1, a5: -1 } },
      { lead: "Put them to work.", ledger: "Put the child to work.", world: "fleshers",
      ...
      { lead: "Send them round the town.", ledger: "Sent the child round the town.", world: "gardeners",
  ...
  },
  {
    ...
    options: [
      { lead: "The tools.", ledger: "Carried out the tools.", world: "hammermen",
      ...
      { lead: "The papers.", ledger: "Carried out the papers.", world: "skinners",
      ...
      { lead: "The grain.", ledger: "Carried out the grain.", world: "bakers",
        ...
        axes: { a1: -2, a2: -3 } },
      { lead: "The people next door.", ledger: "Went through the wall.", world: "barbers",
  ...
  },
  {
    ...
    options: [
      { lead: "Keep the standard.", ledger: "Kept the standard.", world: "tailors",
        ...
        axes: { a2: 3, a4: 1, a5: 1 } },
      { lead: "Take the ones who need it.", ledger: "Took the ones who needed it.", world: "cordiners",
        ...
        axes: { a1: 1, a2: -3, a5: -1 } },
      { lead: "Take down the gate.", ledger: "Took down the gate.", world: "dyers",
      ...
      { lead: "Write it down.", ledger: "Wrote it down.", world: "masons",
