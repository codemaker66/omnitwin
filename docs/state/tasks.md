...
| T-080 | Upgrade Clerk packages, resolve 3 critical CVEs. | not-started | 5 | 4 hr | — | AUDIT-CHATGPT-2026-04-27 (F-004) | `pnpm audit` reports 3 critical Clerk vulnerabilities including middleware route-protection bypasses. Upgrade Clerk packages, regenerate lockfile, run auth regression tests. Add `pnpm audit --audit-level=moderate` as a blocking CI job. |
