...
| T-084 | Triage the 28 failing E2E tests. | not-started | 4 | 1–2 | — | AUDIT-CHATGPT-2026-04-27 (F-007) | `pnpm --filter @omnitwin/web e2e` fails 28/64. Categorise: real product bugs, flaky, stale. Document each at `docs/audits/2026-04-27-e2e-triage.md`. Drives the fix scope tracked under T-086. |
...
| T-086 | Fix 28 E2E test failures (driven by T-084 triage). | not-started | 4 | 3–7 | T-084 | AUDIT-CHATGPT-2026-04-27 (F-007) | Drive E2E pass rate to > 95%. Add screenshots to PR review. Block CI on the full E2E suite. |
